 ...
 */
public class LevelAuthLink extends AuthLink{
  ...
  public LevelAuthLink(String levelUserId, String levelUserName) throws ParseException {
  ...
  public AuthInfo doAuth(String uId, String orderId, Date authDate) {
    ...
    if(null == date) {
      return new AuthInfo("0001", "单号: " + orderId, "状态: 待一级审批人审批" , levelUserName);
    }


    AuthLink next= super.getNext();
    if(next == null) {
      return new AuthInfo("0001", "单号: " + orderId, "状态: 一级审批人审批完成, 审批人: " , levelUserName);
    }


    if(authDate.before(beginDate) || authDate.after(endDate)) {
     return new AuthInfo("0001", "单号: " + orderId, "状态一级审核完成,审批人: " + levelUserName );
